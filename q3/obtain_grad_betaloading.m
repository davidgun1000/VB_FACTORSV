function [grad_beta]=obtain_grad_betaloading(theta_G_idio,theta_G_fact,theta_beta,theta_factscores,y,ctraj_idio,ctraj_fact,num_param_factscores,num_param_betaloading,dim_y,num_fact)
